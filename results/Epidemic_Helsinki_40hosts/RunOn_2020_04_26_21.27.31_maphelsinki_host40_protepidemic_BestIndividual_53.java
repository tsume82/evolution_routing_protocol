...
public class BestIndividual_53 extends ActiveRouter{ 
	...
	public void update() {
		super.update();
if((!(isTransferring() || canStartTransfer()) != ((((!!canStartTransfer() || (!canStartTransfer() != isTransferring())) != canStartTransfer()) || (isTransferring() || canStartTransfer())) != !!isTransferring()))){exchangeDeliverableMessages();}	}
