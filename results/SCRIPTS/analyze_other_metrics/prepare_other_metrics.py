...
files = {
    'Delivery probability': './delivery_prob_median_min_max.csv',
    'Overhead ratio': './overhead_ratio_median_min_max.csv',
    'Latency (avg)': './latency_avg_median_min_max.csv',
    'Hop count (avg)': './hopcount_avg_median_min_max.csv',
    'Buffer time (avg)': './buffertime_avg_median_min_max.csv'
}
