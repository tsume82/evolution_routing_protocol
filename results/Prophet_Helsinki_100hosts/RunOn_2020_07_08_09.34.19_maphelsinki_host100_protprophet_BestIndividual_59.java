...
public double getPredFor(DTNHost host) {
	...
	public void update() {
		super.update();
if(((!(canStartTransfer() || isTransferring()) != ((isTransferring() || canStartTransfer()) || (canStartTransfer() || canStartTransfer()))) != (((canStartTransfer() != isTransferring()) != (isTransferring() != canStartTransfer())) || ((isTransferring() || canStartTransfer()) != (canStartTransfer() || isTransferring()))))){if(((isTransferring() != canStartTransfer()) || (canStartTransfer() || isTransferring()))){if((isTransferring() || isTransferring())){this.tryAllMessagesToAllConnections();
return;}}
if((((isTransferring() || isTransferring()) != canStartTransfer()) || isTransferring())){if(!(!isTransferring() || (canStartTransfer() || isTransferring()))){if(canStartTransfer()){exchangeDeliverableMessages();}}
