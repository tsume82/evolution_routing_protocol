...
public double getPredFor(DTNHost host) {
	...
	public void update() {
		super.update();
if((((canStartTransfer() != isTransferring()) || (canStartTransfer() || isTransferring())) != ((canStartTransfer() || isTransferring()) != (isTransferring() != canStartTransfer())))){if(canStartTransfer()){exchangeDeliverableMessages();}
if(canStartTransfer()){super.update();}
if(canStartTransfer()){return;}
if(canStartTransfer()){exchangeDeliverableMessages();}
if(((!(isTransferring() != canStartTransfer()) != ((isTransferring() != isTransferring()) || (isTransferring() != canStartTransfer()))) || (((canStartTransfer() != isTransferring()) != (canStartTransfer() || canStartTransfer())) != ((canStartTransfer() || canStartTransfer()) != (isTransferring() || canStartTransfer()))))){super.update();}}
if((!(isTransferring() != canStartTransfer()) != ((isTransferring() != isTransferring()) || (isTransferring() != canStartTransfer())))){if((canStartTransfer() != isTransferring())){super.update();}
