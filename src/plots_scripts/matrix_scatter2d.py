...
data_labels_1 = []
data_to_plot_1 = []
with open('../../results/other_metrics_gp.csv', 'r') as csvfile:
...
fig.savefig('../../results/metrics_gp.eps', format='eps', dpi=100)

data_labels_2 = []
data_to_plot_2 = []
with open('../../results/other_metrics_baseline.csv', 'r') as csvfile:
    reader = csv.reader(csvfile, delimiter=';', quotechar='|')
    for row in reader:
...
fig.savefig('../../plots/metrics_baseline.eps', format='eps', dpi=100)

fig=matrixScatter2D_2(data_to_plot_2, data_to_plot_1, data_labels_2, False)
fig.savefig('../../plots/metrics.eps', format='eps', dpi=100)
